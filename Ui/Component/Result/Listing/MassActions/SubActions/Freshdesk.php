...
namespace MageMe\WebFormsFreshdesk\Ui\Component\Result\Listing\MassActions\SubActions;
...
class Freshdesk extends Action
{
    /**
     * @var UrlInterface
     */
    ...
    private function getSendSubmissionMeta(): array
    {
        return [
            ...
            'url' => $this->urlBuilder->getUrl(
                'webformsfreshdesk/result/ajaxCreateTicket'
            ),
            'isAjax' => true,
            'confirm' => [
