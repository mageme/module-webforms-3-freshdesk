...
namespace MageMe\WebFormsFreshdesk\Plugin\MageMe\WebForms\Helper\Result\PostHelper;

use MageMe\WebForms\Api\Data\FormInterface;
use MageMe\WebForms\Api\Data\ResultInterface;
use MageMe\WebForms\Helper\Result\PostHelper;
use MageMe\WebFormsFreshdesk\Helper\Freshdesk\AddTicket;
...
class PostResult
{
     ...
     */
    public function __construct(AddTicket $addTicket)
    {
    ...
    public function afterPostResult(PostHelper $postHelper, array $data, FormInterface $form, array $config = []): array
    {
        ...
        $result = $data['model'];
        if ($form->getFreshdeskIsTicketEnabled()) {
