...
namespace MageMe\WebFormsFreshdesk\Plugin\MageMe\WebForms\Model\ResourceModel\Form;
...
class GetSerializableFields
{
    ...
    {
        $serializableFields[FormInterface::FRESHDESK_TICKET_MAP_FIELDS] = [
            $form::SERIALIZE_OPTION_SERIALIZED => FormInterface::FRESHDESK_TICKET_MAP_FIELDS_SERIALIZED,
